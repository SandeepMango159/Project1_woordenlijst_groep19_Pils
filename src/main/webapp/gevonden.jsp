...
<% Reservering reservering = (Reservering) request.getAttribute("reservering");%>
<!DOCTYPE html>
...
<main>
    <h2>Reservatie gevonden</h2>
    <p class = "pCentraal">Je vroeg naar volgende gegevens: <%=reservering.toString()%></p>
</main>
<footer>
